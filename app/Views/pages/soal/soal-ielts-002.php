            ...
            <table class="tableSoal w-100">
                <tr>
                    <td class="p-3">
                        ...
                        <ul type="radio">
                            <li>available for week beginning <b>1)</b> <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?> <sup>th</sup> May</li>
    ...
    <div class="shadow card mb-3">
        <div class="card-body ps-4">
            ...
            <div class="">
                ...
                <p>
                    <b>15)</b> New car park <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?><br>
                    <b>16)</b> New cricket pitch <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?><br>
                    <b>17)</b> Children’s playground <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?><br>
                    <b>18)</b> Skateboard ramp <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?><br>
                    <b>19)</b> Pavilion <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?><br>
                    <b>20)</b> Notice board <?php echo soal_isian_ielts("jawaban_listening[$i]"); $i++?>
                </p>
            </div>
        </div>
    </div>
                ...
                <div class="col-5">
                    <div class="card">
                        <div class="card-body" style="height: 600px; overflow: scroll">
                            ...
                            <p><b>17</b>   The methodology behind the growth mindset studies was not strict enough.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                            <p><b>18</b>   The idea of the growth mindset has been incorrectly interpreted.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                            <p><b>19</b>   Intellectual ability is an unchangeable feature of each individual.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                            <p><b>20</b>   The growth mindset should be promoted without students being aware of it.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                            <p><b>21</b>   The growth mindset is not simply about boosting students’ morale.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                            <p><b>22</b>   Research shows that the growth mindset has no effect on academic achievement.<?= soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++;?></p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <p>
                                ...
                                One of the remarkable things about Wegener from a <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> is that although he proposed a theory of continental drift, he was not a geologist. His <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> were limited to atmospheric physics. However, at the time he proposed his theory of continental drift in 1912, he was already a person of <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> . Six years previously, there had been his <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> of 52 hours in a hot-air balloon, followed by his well-publicised but <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> of Greenland’s coast. With the publication of his textbook on thermodynamics, he had also come to the attention of a <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_reading[$i]", $choice, "80"); $i++?> of German scientists.
