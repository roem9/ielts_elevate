    ...
    <div class="shadow card mb-3">
        <div class="card-body ps-4">
            <div class="row">
                ...
                <p><b>23</b> The set <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "120"); $i++?></p>
                <p><b>24</b> The lighting <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "120"); $i++?></p>
                <p><b>25</b> The costume design <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "120"); $i++?></p>
                <p><b>26</b> The music <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "120"); $i++?></p>
                <p><b>27</b> The actors' delivery <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "120"); $i++?></p>
...
<?= $this->section('sesi-reading')?>
    ...
    <?php
        $text = "
            ...
            <p><i>The successes and failures of the Doble brothers and their steam cars</i></p>
            <div class=\"reading-2\">
                ((p1))
                    ((b1))A((/b1))((br1))
                ...
                <div class="col-5">
                    <div class="card">
                        ...
                        <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                            ...
                            <p>
                                According to Professor John Hattie of the Melbourne Education Research Institute there is very little indication that streaming leads to <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "80"); $i++?> . He points out that, in schools which use streaming, the most significant impact is on those students placed in the <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "80"); $i++?>, especially where a large proportion of them have <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "80"); $i++?> . Meanwhile, for the <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "80"); $i++?>, there appears to be only minimal advantage. A further issue is that teachers tend to have <?= $i + 1?>)</b> <?php echo soal_select_ielts("jawaban_listening[$i]", $choice, "80"); $i++?> of students in streamed groups.
                            </p>
