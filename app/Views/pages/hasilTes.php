      ...
      <div class="d-lg-flex">
        <div>
          ...
          <p class="text-sm mb-0">
            <?= $nama_client?> - <?= $tipe_tes?> - <?= date('d-M-Y', strtotime($tgl_tes))?> - <?= $nama_tes?>
          </p>
        </div>
      </div>
    </div>
...
<script>
  ...
  function showData() {
    $('#table-hasil-tes').DataTable({
      processing: true,
      serverSide: true,
      ajax: `<?= base_url()?>/tes/getHasilTesIelts/<?= $id_tes?>`,
      responsive: {
          details: {
              type: 'column'
          }
        ...
        },
        {
          ...
          render: function(data, type, row) {
            return `
              ...
              <a href="<?= base_url()?>tes/jawabanPeserta/${row.id_peserta}" target="_blank" class="me-1">
              ...
              <a href="<?= base_url()?>feedbackielts/${row.id_peserta}" target="_blank" class="me-1">
  ...
  function simpanPesertaIelts(e) {
    ...
    $.ajax({
      url: "<?= base_url()?>/tes/simpanPesertaIelts",
      type: "POST",
      data: {
        id: id,
  ...
  function simpanFeedbackWriting(e) {
    ...
    $.ajax({
      url: "<?= base_url()?>/tes/simpanFeedbackWriting",
      type: "POST",
      data: {
        id: id,
        task: task,
  ...
  function simpanFeedbackSpeaking(e) {
    ...
    $.ajax({
      url: "<?= base_url()?>/tes/simpanFeedbackSpeaking",
      type: "POST",
      data: {
        id: id,
